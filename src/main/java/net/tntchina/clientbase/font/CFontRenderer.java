...
public class CFontRenderer extends CFont {
	...
	public final String colorcodeIdentifiers = "0123456789abcdefklmnor";
	...
	public float drawStringWithShadow(final String text, final double x, final double y, final int color) {
		float a = this.drawString(text, x, y, color, true);
		return Math.max(a, this.drawString(text, x, y, color, false));
	}
